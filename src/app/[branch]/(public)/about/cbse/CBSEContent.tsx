...
export default function CBSEContent() {
  ...
  return (
    <main className="bg-white dark:bg-gray-950 pb-20 overflow-hidden">
      {/* Hero */}
      <section className="relative h-[300px] md:h-[400px] flex items-center justify-center overflow-hidden mb-16">
        {/* Background */}
        ...
        <div className="text-center relative z-10">
          ...
          >
            ...
            <h1 className="text-3xl md:text-6xl font-display font-bold text-white mb-4">
              CBSE Disclosure
            </h1>

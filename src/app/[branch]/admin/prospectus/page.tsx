...
export default function AdminProspectusPage() {
  ...
  return (
    <AdminPageGuard requiredPermissionId="prospectus">
      <div className="p-6 max-w-4xl mx-auto space-y-8">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1">
            Manage the common school prospectus link. This link is shared
            globally across all branches. Paste a Google Drive (or any direct
            PDF) link below.
          </p>
        </div>
